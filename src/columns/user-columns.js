...
import { Clear as ClearIcon, EditOutlined as EditIcon, AccountCircle as UserCircleIcon } from "@mui/icons-material";
...
export const UserColumns = ({ handleEdit, handleRemove }) => {
    ...
    const subscriptionColor = useCallback((subscriptions) => {
    ...
    return [
        ...
        },
        {
            ...
            resizable: true,
            width: 150,
            renderCell: (params) => <Typography textTransform="capitalize">
        ...
        },
        {
            ...
            resizable: true,
            width: 150,
            renderCell: (params) => <Chip size="small" color={subscriptionColor(params.value)} label={subscriptionLabel(params.value)} />,
        },
        {
            field: "id",
            type: "actions",

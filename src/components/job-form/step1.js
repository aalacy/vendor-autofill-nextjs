...
xs={12}
sm={6}>
          <InputField name={prodCoName.name}
label={prodCoName.label}
fullWidth />
        </Grid>
        <Grid item
xs={12}
sm={6}>
          <InputField name={contactName.name}
...
xs={12}
sm={6}>
          <InputField name={billAddress.name}
...
xs={12}
sm={6}>
          <InputField name={billCity.name}
label={billCity.label}
fullWidth />
        </Grid>
        <Grid item
xs={12}
sm={6}>
          <InputField name={billState.name}
...
xs={12}
sm={6}>
          <InputField name={billPhone.name}
label={billPhone.label}
fullWidth />
        </Grid>
        <Grid item
xs={12}
sm={6}>
          <InputField name={invoiceEmail.name}
...
xs={12}
sm={6}>
          <InputField name={shipAccountNumber.name}
label={shipAccountNumber.label}
fullWidth />
        </Grid>
        <Grid item
xs={12}
